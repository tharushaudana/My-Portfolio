...
export const metadata = {
  title: 'Project: Live Student Attendance by Face Recognition',
  description: 'Project details for a real-time attendance management system powered by face recognition, Python, and Pandas.',
};
  ...
  return (
    <main className="flex-grow py-20 px-4 sm:px-6">
        ...
        <div className="max-w-7xl mx-auto mb-10">
            {/* Use Next.js Link for client-side navigation back to the homepage */}
            <Link href="/" className="inline-flex items-center text-gray-400 hover:text-white transition duration-150 ease-in-out font-fira">
                <i className="fas fa-arrow-left mr-2"></i> cd ../
            </Link>
        </div>
            ...
            <div className="glass-section max-w-7xl mx-auto py-12 px-8 rounded-lg">
                ...
                <div className="mb-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <Image 
                            className="w-full h-auto rounded-lg glowing-border" 
                            src="https://placehold.co/800x600/161b22/29c53d?text=Attendance+Log" 
                            alt="Attendance Log Screenshot"
                            width={800}
                            height={600}
                        />
                        <Image 
                            className="w-full h-auto rounded-lg glowing-border" 
                            src="https://placehold.co/800x600/161b22/29c53d?text=Excel+Export" 
                            alt="Excel Export Screenshot"
                            width={800}
                            height={600}
                        />
                    </div>
